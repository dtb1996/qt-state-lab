// /qt/qml/QtStateLab/ui/overlays/ErrorOverlay.qml
...
0x64,0x10,0x0,0x0,0xf,0x33,0x45,0xb8,
0xd0,0x4b,0xc7,0xd5,0x63,0xb3,0x1,0x2e,
0xcf,0xcf,0x42,0x65,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x64,0x6,0x0,0x0,0x3,0x0,0x0,0x0,
...
const auto doCall = [&]() {
    void *args[] = {nullptr};
    return aotContext->callObjectPropertyLookup(2, s.v2_1, args, 0);
};
const auto doInit = [&]() {
    aotContext->initCallObjectPropertyLookup(2, s.v2_1, -1);
};
#ifndef QT_NO_DEBUG
...
Q_UNUSED(aotContext)
Q_UNUSED(argv)
// expression for wrapMode at line 32, column 17
struct Storage : QQmlPrivate::AOTTrackedLocalsStorage {
Storage(const QQmlPrivate::AOTCompiledContext *ctxt, void **a)   : aotContext(ctxt), argv(a) {}
void markObjects(QV4::MarkStack *markStack) const final {    Q_UNUSED(markStack);
}
